$(function () {
    ...
    var ws_server = 'ws://localhost:6996/play';
    if (location.protocol === 'http:')
        ws_server = 'ws://' + location.host + '/play';
    ...
    socket.addEventListener('message', function (event) {
        ...
        switch (cmd[0]) {
            ...
            case 'UNDOR':
                ...
                break;
            case 'STT':
                server_stt(event.data.substr(4));
                break;
            case 'PB':
                server_progress(parseInt(cmd[1]));
                break;
            case 'L':
                server_log(event.data.substr(2));
                break;
            case 'MSG':
                server_msg(event.data.substr(4));
                break;
            case 'LOGCLR':
                ai_logs.value = '';
                ai_msg.text('');
    ...
    socket.addEventListener('close', function (event) {
        ...
        update_ws_status('Error ' + event.code, '#f44336');
    });
